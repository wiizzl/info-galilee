...
const components: Record<string, React.ComponentType<any>> = {
    h1: ({ className, ...props }): React.ReactElement => (
        <h1 className={cn("mt-2 scroll-m-20 text-4xl font-bold tracking-tight", className)} {...props} />
    ),
    h2: ({ className, ...props }): React.ReactElement => (
        <h2
            className={cn("mt-10 scroll-m-20 border-b pb-1 text-3xl font-semibold tracking-tight first:mt-0", className)}
            {...props}
        />
    ),
    h3: ({ className, ...props }): React.ReactElement => (
        <h3 className={cn("mt-8 scroll-m-20 text-2xl font-semibold tracking-tight", className)} {...props} />
    ),
    h4: ({ className, ...props }): React.ReactElement => (
        <h4 className={cn("mt-8 scroll-m-20 text-xl font-semibold tracking-tight", className)} {...props} />
    ),
    h5: ({ className, ...props }): React.ReactElement => (
        <h5 className={cn("mt-8 scroll-m-20 text-lg font-semibold tracking-tight", className)} {...props} />
    ),
    h6: ({ className, ...props }): React.ReactElement => (
        <h6 className={cn("mt-8 scroll-m-20 text-base font-semibold tracking-tight", className)} {...props} />
    ),
    a: ({ className, ...props }): React.ReactElement => (
        <a className={cn("font-medium underline underline-offset-4", className)} {...props} />
    ),
    p: ({ className, ...props }): React.ReactElement => (
        <p className={cn("leading-7 [&:not(:first-child)]:mt-6", className)} {...props} />
    ),
    ul: ({ className, ...props }): React.ReactElement => <ul className={cn("my-6 ml-6 list-disc", className)} {...props} />,
    ol: ({ className, ...props }): React.ReactElement => <ol className={cn("my-6 ml-6 list-decimal", className)} {...props} />,
    li: ({ className, ...props }): React.ReactElement => <li className={cn("mt-2", className)} {...props} />,
    blockquote: ({ className, ...props }): React.ReactElement => (
    ...
    hr: ({ ...props }): React.ReactElement => <hr className="my-4 md:my-8" {...props} />,
    ...
    th: ({ className, ...props }): React.ReactElement => (
        <th
            className={cn(

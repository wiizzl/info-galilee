...
const components: Components = {
    ...
    h2: ({ className, ...props }) => (
        <h2
            className={cn("croll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0", className)}
            {...props}
        />
    ),
    h3: ({ className, ...props }) => (
    ...
    ol: ({ type, className, ...props }) => (
        <ol type="1" className={cn("my-6 ml-6 list-decimal", className)} {...props} />
    ),
    ...
    code: ({ className, ...props }) => <code className={cn("p-3", className)} {...props} />,
    Image: ({ className, src, size, ...props }) => (
        <Image
            className={cn("rounded-md bg-accent-foreground p-2", className)}
            src={src}
            alt="Image du cours"
            width={size}
            height={size}
